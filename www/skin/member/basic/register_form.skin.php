	...
	<div id="register_form" class="form_01">   
	    ...
	    <div class="tbl_frm01 tbl_wrap register_form_inner">
	        ...
	        <ul>
                ...
                <li>
	                <label for="reg_mb_1">성별 (필수)</label>
	                <select name="mb_1" id="reg_mb_1" class="frm_input full_input">
                      <option value="남자" <?php if($member['mb_1'] == "남자"){ echo "selected"; } ?>>남자</option>
                      <option value="여자" <?php if($member['mb_1'] == "여자"){ echo "selected"; } ?>>여자</option>
                    </select>
	            </li>
                
                <li>
	                <label for="reg_mb_2">생년월일 (필수)</label>
	                <input type="text" name="mb_2" value="<?php echo get_text($member['mb_2']) ?>" id="reg_mb_2" class="frm_input full_input" placeholder="생년월일">
	            </li>
	    ...
	    <div class="tbl_frm01 tbl_wrap register_form_inner">
	        ...
	        <ul>
                ...
                <li>
	                <label for="reg_mb_3">기본클럽</label>
	                <input name="mb_3" id="reg_mb_3" class="frm_input full_input" placeholder="기본클럽" value="<?php echo $member['mb_3'] ?>">
	            </li>
                
                <li>
	                <label for="reg_mb_4">기타클럽</label>
	                <input name="mb_4" id="reg_mb_4" class="frm_input full_input" placeholder="기타클럽" value="<?php echo $member['mb_4'] ?>">
	            </li>
            </ul>
            <div>
	            <?php if ($config['cf_use_profile']) {  ?>
	                <label for="reg_mb_profile">경력사항</label>
	                <textarea name="mb_profile" id="reg_mb_profile" <?php echo $config['cf_req_profile']?"required":""; ?> class="<?php echo $config['cf_req_profile']?"required":""; ?>" placeholder="경력사항"><?php echo $member['mb_profile'] ?></textarea>
	            <?php }  ?>
            </div>
...
gif, jpg, png파일만 가능하며 용량 <?php echo number_format($config['cf_member_icon_size']) ?>바이트 이하만 등록됩니다.</span>
	...
	<div class="btn_confirm">
	    <a href="<?php echo G5_URL ?>" class="btn_close btn01 btn">취소</a>
