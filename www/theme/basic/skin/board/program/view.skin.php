...
;
    ...
    <section id="bo_v_atc">
        <h2><?php echo cut_str(get_text($view['wr_subject']), 70); // 글제목 출력 ?></h2>
        <div>
          <ul>
              <li id="leftThum">
			  <?php
              ...
              <li id="rightThum">
                <div><h5>대회명</h5><span><?php echo $view['wr_1']; ?></span></div>
                <div><h5>대회요강</h5><span><?php echo $view['wr_2']; ?></span></div>
                <div><h5>부서</h5><span><?php echo $view['wr_3']; ?></span></div>
                <div><h5>대회접수기간</h5><span><?php echo $view['wr_3']; ?> ~ <?php echo $view['wr_4']; ?></span></div>
                <div><h5>대회기간</h5><span><?php echo $view['wr_6']; ?> ~ <?php echo $view['wr_7']; ?></span></div>
                <div><h5>코트명</h5><span><?php echo $view['wr_9']; ?></span></div>
                <div><h5>세부코트</h5><span><?php echo $view['wr_10']; ?></span></div>
                
                <div><h5>링크</h5><span><a href="http://<?php echo $view['wr_9']; ?>" target="new"><?php echo $view['wr_9']; ?></a></span></div>
              </li>
          </ul>
        </div>

        <!-- 본문 내용 시작 { -->
        <div id="bo_v_con" style="clear:both;">
		   <h2><span>상세정보</span></h2>
