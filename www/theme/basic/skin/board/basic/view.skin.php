...
<style>
.contbtn { text-align:right; padding:0px; }
.contbtn button { display:inline-block; vertical-align:top; width:100px; }
</style>
    ...
    <section id="bo_v_info">
	    ...
	    <div id="bo_v_top">
	        ...
	        <ul class="btn_bo_user bo_v_com">
		        ...
		        <li class="contbtn" style="width:150px;"> 
				<?php if ($update_href) { ?>
                <a href="<?php echo $update_href ?>"class="btn_bo_sch btn_b01 btn"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> 수정</a>
				<?php } ?>
                <?php if ($delete_href) { ?>
                <a href="<?php echo $delete_href ?>" onclick="del(this.href); return false;"class="btn_bo_sch btn_b01 btn"><i class="fa fa-trash-o" aria-hidden="true"></i> 삭제</a>
				<?php } ?>
	        	</li>
	        	<?php } ?>
	        </ul>
