...
;
    ...
    <section id="bo_v_atc">
        <div>
          <ul>
              ...
              <li id="rightThum">
                ...
                <div id="bo_v_tables"><?php echo nl2br($view['wr_1']); // 모델 ?></div>
              </li>
          </ul>
        </div>
        ...
        <div id="bo_v_con" style="clear:both;">
		   <h2>상세내용</h2>
		   <div style="border:1px solid #ddd; margin-top:15px; padding:20px;"><?php echo get_view_thumbnail($view['content']); ?></div>
        </div>
