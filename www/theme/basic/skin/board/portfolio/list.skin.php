            ...
            <div class="gall_box">
                ...
                <div class="gall_con">
                    ...
                    <div class="gall_text_href">
                        <h3><span><?php echo $list[$i]['wr_1'] ?></span></h3>
                        <div><a href=""><?php echo $list[$i]['subject'] ?></a></div>
                        <p>
                          <?php
						    $wr3list = explode(",",$list[$i]['wr_2']); 
							for($j=0; $j<count($wr3list); $j++){
